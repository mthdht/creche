...
const submit = () => {
    form.post(route('daycares.children.allergies.store', {daycare: props.daycare.id, child: props.child.id}));
};

</script>

<template>
    <Head title="Création d'une allergie" />
        ...
        <div class="space-y-4">
            <h2 class="font-semibold text-xl flex justify-between gap-3">
                <div class="flex gap-3">
                    ...
                    Ajouter une allergie à {{  props.child.first_name }}    
                </div>
            </h2>
